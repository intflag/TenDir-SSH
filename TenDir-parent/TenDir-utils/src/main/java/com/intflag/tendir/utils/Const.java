...
public class Const {
	 ...
	 *解锁成功
	 */
	public static final String UNLOCK_SUCCEED = "解锁成功";
	/**
	 *解锁失败
	 */
	public static final String UNLOCK_FAIL = "解锁失败";
	/**
	 *查找成功
	 */
	public static final String FIND_SUCCEED = "查找成功";
	/**
	 *查找失败
	 */
	public static final String FIND_FAIL = "查找失败";
	/**
	 *保存成功
	 */
	 ...
	 *数据删除异常
	 */
	public static final String DEL_EXCEPTION = "请先删除或修改满意度中相连选项";
