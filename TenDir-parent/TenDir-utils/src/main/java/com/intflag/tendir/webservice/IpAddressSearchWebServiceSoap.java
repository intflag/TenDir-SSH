...
public interface IpAddressSearchWebServiceSoap {
     ...
     * @param theIpAddress
     * @return
     *     returns com.intflag.tendir.webservice.ArrayOfString
     */
    ...
    @RequestWrapper(localName = "getCountryCityByIp", targetNamespace = "http://WebXml.com.cn/", className = "com.intflag.tendir.webservice.GetCountryCityByIp")
    @ResponseWrapper(localName = "getCountryCityByIpResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.intflag.tendir.webservice.GetCountryCityByIpResponse")
    ...
    @RequestWrapper(localName = "getGeoIPContext", targetNamespace = "http://WebXml.com.cn/", className = "com.intflag.tendir.webservice.GetGeoIPContext")
    @ResponseWrapper(localName = "getGeoIPContextResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.intflag.tendir.webservice.GetGeoIPContextResponse")
    ...
    @RequestWrapper(localName = "getVersionTime", targetNamespace = "http://WebXml.com.cn/", className = "com.intflag.tendir.webservice.GetVersionTime")
    @ResponseWrapper(localName = "getVersionTimeResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.intflag.tendir.webservice.GetVersionTimeResponse")
