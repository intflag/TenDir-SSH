...
var Demo = function() {
  ...
  , Basic = function(a) {
    this.elem = a;
    this.data = function() {
        return '{"tooltip":{"formatter":"{a} <br/>{b} : {c}%"},"series":[{"name":"业务指标","type":"gauge","detail":{"formatter":"{value}%","width":"90","height":"60"},"center":["50%","70%"],"radius":"120%","startAngle":180,"endAngle":0,"data":[{"value":85,"name":"完成率"}]}]}'
    }
    ;
  ...
  , Combo = function(a, b) {
    ...
    this.data = function() {
        return {
        	options: '{"title":{"text":"站点用户访问来源","subtext":"纯属虚构","x":"center"},"tooltip":{"trigger":"item","formatter":"{a} <br/>{b} : {c} ({d}%)"},"legend":{"orient":"vertical","left":"left","data":["直接访问","邮件营销","联盟广告","视频广告","搜索引擎"]},"series":[{"name":"访问来源","type":"pie","radius":"55%","center":["50%","60%"],"data":[{"value":335,"name":"直接访问"},{"value":310,"name":"邮件营销"},{"value":234,"name":"联盟广告"},{"value":135,"name":"视频广告"},{"value":1548,"name":"搜索引擎"}],"itemstyle":{"emphasis":{"shadowblur":10,"shadowoffsetx":0,"shadowcolor":"rgba(0, 0, 0, 0.5)"}}}]}',
