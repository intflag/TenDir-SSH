...
<table class="layui-table" lay-data="{width: 892, height:332, url:'${pageContext.request.contextPath}/statics/json/adminTest.json', page:true, id:'idTest'}" lay-filter="demo">
  <thead>
    <tr>
