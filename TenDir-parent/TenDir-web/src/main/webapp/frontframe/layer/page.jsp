    ...
    <div class="layui-tab-content" >
        <div class="layui-tab-item layui-show">
            <textarea class="layui-textarea" rows="12" class="layui-code">
             ...
             <button class="layui-btn" onclick="Page.open('打开新窗口','${pageContext.request.contextPath}/frontframe/layer/main.jsp','test1')">打开窗口</button> </br></br>

             <button class="layui-btn" onclick="Page.max('窗口最大化','${pageContext.request.contextPath}/frontframe/layer/main.jsp')">打开窗口最大化</button> </br></br>
